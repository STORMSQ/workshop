...
<?php $__env->startSection('content'); ?>
    ...
    <?php for($i=0;$i<=count($info['class'])-1;$i++): ?>
            ...
            <tr style="<?php echo e(($info['class'][$i]['full']=='本課程連同候補位皆已額滿')?'background-color:gray':''); ?>" <?php echo e(($info['class'][$i]['full']!='額滿')?'id=tr'.$info['class'][$i]['id']:''); ?> align="center"><td><?php echo e($info['semester']['year'].$info['semester']['identity'].'-'.str_pad($info['class'][$i]['sort'],2,"0",STR_PAD_LEFT)); ?></td><td ><a><?php echo e($info['class'][$i]['className']); ?></a></td><td>每週 <?php echo e($info['class'][$i]['week']); ?><br><?php echo e($info['class'][$i]['start']); ?>-<?php echo e($info['class'][$i]['end']); ?></td><td><?php echo e($info['class'][$i]['teacher']); ?></td><td><?php echo e($info['class'][$i]['startdate']); ?><br><?php echo e($info['class'][$i]['enddate']); ?></td><td><?php echo e($info['class'][$i]['range']); ?></td><td><a id="count<?php echo e($info['class'][$i]['id']); ?>"><?php echo e($info['class'][$i]['full']); ?></a></td><td width="15%"><label for="box<?php echo e($info['class'][$i]['id']); ?>">
                        <?php if($info['class'][$i]['full']!='本課程連同候補位皆已額滿'): ?>
